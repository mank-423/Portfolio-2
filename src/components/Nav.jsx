  ...
  return (
    <nav>
      <div className="w-full">
        <div className="flex items-center justify-center py-4 md:px-2 px-7">
          ...
          <ul
            className={`flex justify-center items-center md:pb-0 pt-4 absolute md:static  
          ...
          {/* ${open ? 'top-20 opacity-100' : 'top-[-490px] opacity-0 '}
            ...
            {links.map((link) => (
              <li key={link.id} className="md:ml-8 text-xl md:my-0 my-4 px-4">
                <Link to={link.link} className="text-white hover:text-gray-500 duration-400">
